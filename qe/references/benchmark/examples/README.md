...
| `results/scorecard.json` | Computed by `../../../scripts/benchmark/scoring/score.py` from the evidence — **no score is ever typed by hand** |
...
## The shared HIGH anchor — `../../../scripts/benchmark/calibration/bellman_bench.py`
