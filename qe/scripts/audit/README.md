...
Fetching is mechanical, so it belongs here rather than in model judgement ([doctrine §4](../../references/audit/doctrine.md#4-checkpointing)). Stdlib only, driving `gh`; no install step.
