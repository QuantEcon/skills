...
Usage:
    python scripts/benchmark/scoring/env_stamp.py <lecture-dir> [failed-step-title ...]
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        sys.exit("usage: python scripts/benchmark/scoring/env_stamp.py <lecture-dir> [failed-step-title ...]")
