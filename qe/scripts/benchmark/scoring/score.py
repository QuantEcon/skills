...
Usage:
    python scripts/benchmark/scoring/score.py <lecture-dir>
    # e.g. python scripts/benchmark/scoring/score.py references/examples/ge_arrow
...
def main(lecture_dir):
    ...
    out = {
        ...
        "_note": "Scores are computed by scripts/benchmark/scoring/rubric.py from "
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.exit("usage: python scripts/benchmark/scoring/score.py <lecture-dir>")
    main(sys.argv[1])
